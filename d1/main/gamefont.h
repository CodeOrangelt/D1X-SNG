...
#define FSPACX2(x)	((float)((x)*(FNTScaleX*(MEDIUM1_FONT->ft_w/7))))
#define FSPACY(y)	((float)((y)*(FNTScaleY*(GAME_FONT->ft_h/5))))
#define FSPACY2(y)	((float)((y)*(FNTScaleY*(MEDIUM1_FONT->ft_h/5))))

#define LINE_SPACING    ((float)(FNTScaleY*(grd_curcanv->cv_font->ft_h+(GAME_FONT->ft_h/5))))
#define LINE_SPACING2    ((float)(FNTScaleY*(grd_curcanv->cv_font->ft_h+(MEDIUM1_FONT->ft_h/5))))
